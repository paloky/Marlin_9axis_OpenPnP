...
#endif
#if LINEAR_AXES >= 10    /**SG**/
  #define _Q_HALF_QMAX ((Q_BED_SIZE) / 2)
#endif
...
#endif
#if ANY_PIN(MOTOR_CURRENT_PWM_X, MOTOR_CURRENT_PWM_Y, MOTOR_CURRENT_PWM_XY, MOTOR_CURRENT_PWM_Z, \
            MOTOR_CURRENT_PWM_I, MOTOR_CURRENT_PWM_J, MOTOR_CURRENT_PWM_K, MOTOR_CURRENT_PWM_M, MOTOR_CURRENT_PWM_O, MOTOR_CURRENT_PWM_P, MOTOR_CURRENT_PWM_Q, MOTOR_CURRENT_PWM_E)  /**SG**/
...
#endif
#if ANY(HAS_X_MS_PINS, HAS_X2_MS_PINS, HAS_Y_MS_PINS, HAS_Y2_MS_PINS, HAS_SOME_Z_MS_PINS, HAS_I_MS_PINS, HAS_J_MS_PINS, HAS_K_MS_PINS, HAS_M_MS_PINS, HAS_O_MS_PINS, HAS_P_MS_PINS, HAS_Q_MS_PINS, HAS_SOME_E_MS_PINS)  /**SG**/
