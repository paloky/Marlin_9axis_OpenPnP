...
//
  ...
  #define O_SERIAL_TX_PIN                  PG10
  #define O_SERIAL_RX_PIN                  PG10
 ...
 // #define E0_SERIAL_RX_PIN                  PG10
  ...
  #define J_SERIAL_TX_PIN                  PC12
  #define J_SERIAL_RX_PIN                  PC12
  //#define E2_SERIAL_TX_PIN                  PC12
  //#define E2_SERIAL_RX_PIN                  PC12

  #define K_SERIAL_TX_PIN                  PG4
  #define K_SERIAL_RX_PIN                  PG4
  //#define E3_SERIAL_TX_PIN                  PG4
  //#define E3_SERIAL_RX_PIN                  PG4
 
  #define M_SERIAL_TX_PIN                  PE15
  #define M_SERIAL_RX_PIN                  PE15
