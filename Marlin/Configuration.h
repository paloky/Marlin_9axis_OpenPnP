 ...
 */
#if LINEAR_AXES >= 4   // I_AXIS  --> OpenPnP C1
  #define AXIS4_NAME 'A' // :['A', 'B', 'C', 'D', 'U', 'V', 'W']
#endif
#if LINEAR_AXES >= 5  // J_AXIS   --> OpenPnP C2
  #define AXIS5_NAME 'B' // :['A', 'B', 'C', 'D', 'U', 'V', 'W']
#endif
#if LINEAR_AXES >= 6  // K_AXIS   --> OpenPnP C3
  #define AXIS6_NAME 'C' // :['A', 'B', 'C', 'D', 'U', 'V', 'W']
#endif
#if LINEAR_AXES >= 7  // M_AXIS   --> OpenPnP C4
  #define AXIS7_NAME 'D' // :['A', 'B', 'C', 'D', 'U', 'V', 'W']
#endif
#if LINEAR_AXES >= 8  // O_AXIS  --> OpenPnP Z2
...
#define O_DRIVER_TYPE  TMC2209    /**SG**/
